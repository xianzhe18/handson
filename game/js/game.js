...
var categoryPage = false; //show/hide category select page 		modified by PCG
...
var gameData = {page:'', questionNum:0, sequenceNum:0, categoryNum:3, category_arr:[], categoryThumb_arr:[], sequence_arr:[], targetArray:null, targetAnswerSequence:null, mode:'landscape', oldMode:'landscape', build:false};
...
function checkAnswerCorrect(){
	...
	if(playerData.answerType == 'select'){
		if (playerData.answer_arr.length == playerData.correctAnswer.length) {			//this is added code by PCG
			for(var n=0;n<playerData.answer_arr.length;n++){
